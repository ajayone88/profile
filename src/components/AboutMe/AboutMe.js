        ...
        <Auxillary>
            <section id="aboutMe" className="section__aboutMe">
                ...
                <div className="section__aboutMe-box">
                  <ul>
                      <li>I am from <strong>India</strong>, I was born and brought up in Mumbai Maharashtra, Mumbai is also known as <strong>city of dreams</strong>, Mumbai teaches everyday something new, I celebrate my birthday on <strong>31st of October</strong> every year of course I was born on that day. Currently I am residing in Amstelveen <strong>(Netherland)</strong>.</li>
